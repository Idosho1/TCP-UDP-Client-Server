...
# close the UDP socket after 2 minutes of inactivity
...
while True:
    ...
    # try to recieve a message without timeout
    try:
        # receive message from client
        message, (client_address, client_port) = serverSocket.recvfrom(2048)
        ...
        serverSocket.sendto(reply.encode(), (client_address, client_port))
    except timeout:
